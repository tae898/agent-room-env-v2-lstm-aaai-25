"""Handcrafted Agent for the RoomsEnv environment."""
...
from memory.memory import (EpisodicMemory, MemorySystems, SemanticMemory,
                            ShortMemory)
from memory.policy import (answer_question, encode_observation, explore,
                            manage_memory)
...
class HandcraftedAgent:
    ...
    def __init__(
        self,
        env_str: str = "rooms_env:RoomsEnv",
        env_config: dict = {
            "question_prob": 1.0,
            "seed": 42,
            "terminates_at": 99,
        ...
        Args:
            env_str: This has to be "rooms_env:RoomsEnv"
